...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Visar deklarationerna som har skrivits i koden");
        System.out.println("int age = 30");
        System.out.println("double height = 1.75");
        System.out.println("char initial = 'A'");
        ...
        System.out.println("| --------------------------------------------------- |");
        System.out.println("| Uppgifter 1.2 Skriva ut variabler och värde och typ |");
        System.out.println("| --------------------------------------------------- |");
